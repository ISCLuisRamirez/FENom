...
export class DatatablesComponent implements OnInit {
  ...
  public filteredRows: any[] = []; // Almacenará las filas filtradas por estatus
  ...
  filterByStatus() {
    if (this.selectedStatus) {
      ...
      this.filteredRows = [...this.kitchenSinkRows]; // Si no hay filtro, muestra todas las filas
    }
  }
  ...
  ngOnInit() {
    this._datatablesService.onDatatablessChanged.pipe(takeUntil(this._unsubscribeAll)).subscribe(response => {
      ...
      this.filteredRows = [...this.kitchenSinkRows]; // Inicialmente, las filas filtradas son las mismas que todas
    });
